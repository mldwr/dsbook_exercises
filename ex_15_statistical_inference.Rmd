...
The degrees of freedom are computed as a product of the dimensions of the table minus one. In this case the table has two rows and two columns, hence the dimension of a 2x2 matrix, therefore the degrees of freedom are df=(2-1)(2-2)=1.
