...
Here, the lower case letter $d$ denotes the spread and is defined as $d = \bar{X} - (1-\bar{X})$. \ The following auxiliary equation from previous exercise is used $E[\bar{X}]=p$. \
...
Again, the spread is defined as $d = \bar{X} - (1-\bar{X})$. \
