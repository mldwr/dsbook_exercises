...
Recall the standard error of the spread from exercise 8: $\mbox{SE}(d)= 2\sqrt{p(1-p)/N}$. Where $p$ is calculated by rearranging the definition of the spread to $p=(d-1)/2$.
...
polls<-left_join(pollsters,polls) %>% select(pollnr,pollster,n,samplesize,rawpoll_clinton,rawpoll_trump,d_hat)
