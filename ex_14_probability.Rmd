...
Then we make random draw with `sample` and repeate the random draw with `replicate` for a large number of times (B), then we evalute the result with `prop.table`.
```{r}
B <- 10000
