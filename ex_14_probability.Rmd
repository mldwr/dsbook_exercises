...
set.seed(1986)
nr_perms <- 10000
events <- replicate(nr_perms, sample(balls, 2))
tab <- table(events)
prop.table(tab)
```
...
set.seed(1986)
nr_perms <- 10000
events <- sample(balls, nr_perms, replace = TRUE)
...
nr_perms <- 100000
cyan <- "cyan"
perms <- replicate(nr_perms,sample(balls,2))
first_draw <- perms[1,]
second_draw <- perms[2,]
...
nr_perms <- 100000
cyan <- "cyan"
perms <- replicate(nr_perms,sample(balls,2,replace = TRUE))
first_draw <- perms[1,]
second_draw <- perms[2,]
sum(first_draw %in% cyan & !second_draw %in% cyan)/sum(first_draw %in% cyan)
```
...
The probability of seeing a 6 is 1/6 and of not seeing a 6 1-1/6=0.83 or 83%.
