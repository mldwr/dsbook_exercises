...
For example, the expression $\mbox{Pr}(\mbox{mother murderer} \mid \mbox{dead with no harm})$ is read, what is the probability that a mother is the murderer of her children, given that two children found dead with no harm. 
$$
