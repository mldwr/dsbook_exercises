...
_a mother is a son-murdering psychopath_ = _mother murderer_ and
_two of her children are found dead with no evidence of physical harm_ = _dead with no harm_.


$$
\mbox{Pr}(\mbox{mother murderer} \mid \mbox{dead with no harm}) = \frac{\mbox{Pr}(\mbox{mother murderer})\ \mbox{Pr}(\mbox{dead with no harm} \mid \mbox{mother murderer})}{\mbox{Pr}(\mbox{dead with no harm})}
$$
...
The expression $\mbox{Pr}(H \mid E)$ is read as what is the probability of a hypothesis $H$ being true, if $D$ has already occurred, where $E$ denotes the evidence, data or the facts. 
...
$$
\mbox{Pr}(H \mid D)  =  \frac{\mbox{Pr}(D \mid H) \mbox{Pr}(H)}{\mbox{Pr}(E)} = \frac{\mbox{Pr}(E \mid H)\mbox{Pr}(H)}{\mbox{Pr}(D \mid H)\mbox{Pr}(H) + \mbox{Pr}(E \mid \mbox{not }H)\mbox{Pr}(\mbox{not }H)}
$$
...
2. $\mbox{Pr}(\mbox{dead with no harm} \mid \mbox{mother murderer}) = 1/2$ and\
3. $\mbox{Pr}(\mbox{dead with no harm})=1/850000$. \

$$
\mbox{Pr}(\mbox{mother murderer} \mid \mbox{dead with no harm}) = \frac{1/1000000 \cdot 1/2}{1/850000} = \frac{17}{40} = 0.425
$$
