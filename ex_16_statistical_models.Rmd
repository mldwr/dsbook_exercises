...
However, other authors assume different probabilities. For example, in the article^[https://doi.org/10.1111/j.1365-3016.2004.00560.x Hill, R. (2004) Multiple sudden infant deaths – coincidence or beyond coincidence?, Pediatric and
Perinatal Epidemiology, 18, 320-326] the author concluded that the probability of two SIDS cases is $\mbox{Pr}(\mbox{second case of SIDS}) = 1/1300 \cdot 57/13000 = 3.37\cdot 10^{-06}$. Nevertheless, this probability is in the same order of magnitude. \
...
From this it follows, that the jury assumed the probability Sally Clark being guilty is $1-\frac{1}{73\cdot 10^{6}}$. \
...
A more general view on this question would be to take the two competing hypothesis explicitly into account^[https://doi.org/10.1111/j.1365-3016.2004.00560.x Hill, R. (2004) Multiple sudden infant deaths – coincidence or beyond coincidence?, Pediatric and
Perinatal Epidemiology, 18, 320-326]. \
...
$D$: event of two dead children.\

$$
\frac{\mbox{Pr(S|D)}}{\mbox{Pr(M|D)}} = \frac{\mbox{Pr(D|S)}\cdot \mbox{Pr(S)}}{\mbox{Pr(D|M)}\cdot \mbox{Pr(M)}}
$$
Here, the probabilities of $\mbox{Pr(D)}$ cancel each other out. 
