...
The p-value can be computed by dividing the expected value $\bar{Y_2}-\bar{Y}_1$ of by its standard error: $\frac{E[\bar{Y}_{2} - \bar{Y}_1]}{SE[\bar{Y}_{2} - \bar{Y}_1]}=\frac{b_2-b_1}{\sqrt{\sigma_2^2/N_2+\sigma_1^2/N_1}}$. \
