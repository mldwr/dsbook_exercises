...
In **chapter 15.9** "_p-values_" the concept was introduced by computing the ratio of $z=\frac{\mid\bar{X}-E[\bar{X}]\mid}{SE[p]}=\frac{\mid \bar{X} - p\mid}{\sqrt{p(1-p)/N}}$. Then the ratio $z$ was plugged into the standard normal distribution function `1 - (pnorm(z) - pnorm(-z))` in order to gain the actual p-value \
