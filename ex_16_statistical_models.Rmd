...
Recall the necessary equations: the expectation value $E[\bar{Y}_{2} - \bar{Y}_1] = b_2-b_1$ and the standard error $SE[\bar{Y}_{2} - \bar{Y}_1] = \sqrt{\frac{\sigma_2^2}{N_2}+\frac{\sigma_1^2}{N_1}}$. \
