...
Recall the necessary equations: the expectation value $E[\bar{Y}_{2} - \bar{Y}_1] = b_2-b_1$ from question 14 and the standard error $SE[\bar{Y}_{2} - \bar{Y}_1] = \sqrt{\frac{\sigma_2^2}{N_2}+\frac{\sigma_1^2}{N_1}}$ from question 15. \
...
ratio<-EY2Y1/SE
p<-round(2*(1-pnorm(ratio)),8)
data.frame(names=c("p","ratio","ci1","ci2","EY2Y1","SE"), values=c(p,ratio,ci1,ci2,EY2Y1,SE))
```
### Qn
