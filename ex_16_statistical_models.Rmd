...
merge(x,y,all=TRUE) %>% mutate(se=sqrt(a.sigsqN+b.sigsqN),EXEY=b.EY-a.EY,z=EXEY/se,tstat=2*(1-pnorm(z))) %>% select(a.pollster,b.pollster, se,EXEY,z,tstat) %>% arrange(a.pollster,b.pollster) 
#%>% filter(str_detect(a.pollster,"Pulse"))
```
