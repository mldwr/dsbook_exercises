...
The chances are 18/38: lose for the casino, win for the gambler and 20/38: win for casino, lose for gambler.
If the gambler is allowed to bet on green then he loses if the ball lands on red or black.
Therefore the chances 2/38 to lose for the gambler and 36/38 to win for the casino. If the payout would stay at 1\$ this game is rather disadvantageous for the gambler.
