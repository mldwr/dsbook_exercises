...
By the way, the probability of hitting green is also 1/19$\approx$0.05, where the probability of hitting red is about a hundred times larger 9/19$\approx$0.5.
...
$$
\mid 1 - (-17) \mid \sqrt{18/19 \times 1/19}=17*\sqrt{\frac{18}{361}}=17*\frac{\sqrt{18}}{19}
$$
